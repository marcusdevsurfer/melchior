...
public class FallbackIntentHandler implements RequestHandler {
    ...
    public FallbackIntentHandler(ChatClient.Builder chatClient) {
    ...
    public Optional<Response> handle(HandlerInput input) {
        ...
        // Obtener la pregunta del usuario del fallback
        String userQuery = "ayuda con programación"; // Valor por defecto
        
        // Debug: Imprimir información del fallback
        System.out.println("=== DEBUG FallbackIntentHandler ===");
        ...
        // Intentar obtener la pregunta del slot de fallback
        ...
        return input.getResponseBuilder()
                ...
                .withSimpleCard("Gaspar contesta", aiResponse)
                .build();
    }
}
